    ...
    function page_even() {
        ...
        function change_content(){
            ...
            for(var i = 0;i<per_num;i++)//每页显示的页数。如何调整每页显示的内容刚好对应相应的俄页面
            {
                ...
                pageContent+='<div class="item item2"><p><a href="/cdetail?id='+data[i].id+'"id="Chemical-name">'+data[i].basic.proteinName+'</a></p><div class="chemical-member"><ul><li><p id="basic">Basic Information</p></li><li><p id="related">Related Molecules</p></li></ul></div></div>';
