...
//     			target_content+='</li>';
//     		}
//    //  	$("#contentList").find('li:nth-child("'+per_num*(current_page-1)+i+1+'")').children(".item2").click(function(){
...
// 			// // 	// console.log($(this).)
// 			// // 	}
// 			// // $(this).find("#Chemical-name").
//    //  	});
//     	target_content+='</ul>';
//     	$(obj_box).children('.page_content').html(target_content);
// 		// $("<li>")
// 		// .append('<div class="item item1"><p class="ID-link">ID: <a href="#"id="ID-link">'+items.idLink+'</a></p></div>')
// 		// .append('<div class="item item2"><p><a href="#"id="Chemical-name">'+items.name+'</a></p><div class="chemical-member"><ul><li><p id="basic">Basic Information</p></li><li><p id="pathway">Pathway</p></li><li><p id="related">Related Compounds</p></li><li><p id="supporting">Supporting Information</p></li></ul></div></div>')
// 		// .append('<div class="item item3-t"><ul><li>Protein <span id="Protein">'+items.basic.protein+'</span></li><li>Organism <span id="Organism">'+items.basic.organism+'</span></li><li>Uniprot ID <span id="UniprotId">'+items.basic.uniportID+'</span></li><li>Gene <span id="gene">'+items.basic.gene+'</span></li><li>Function <span id="function">'+items.basic.Function+'</span></li></ul></div>')
...
//       // for(var i=0;i<per_num;i++){//每页显示的条目*当前页面数减1+i就是该页面上的每一条加1
